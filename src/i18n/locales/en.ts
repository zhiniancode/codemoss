const en = {
  ...
  sidebar: {
    ...
    cliSection: "CLI Workspaces",
    openaiSection: "Custom API",
    openaiNewChat: "New Custom API chat",
    openaiAddFolder: "Add Custom API folder",
    openaiEmpty: "Start a Custom API chat without a project, or add a folder for context.",
  ...
  settings: {
    ...
    vendorsDescription: "Manage API vendor configurations for Claude, Codex, and OpenAI-compatible endpoints.",
    vendor: {
      allProviders: "All Providers",
      allCodexProviders: "All Codex Providers",
      allOpenAIProviders: "All Custom API Providers",
      add: "Add",
      edit: "Edit",
      delete: "Delete",
      enable: "Enable",
      ...
      emptyOpenAIState:
        "No OpenAI-compatible providers yet. Click \"Add\" above to create one.",
      dialog: {
      ...
      openaiDialog: {
        addTitle: "Add Custom API Provider",
        editTitle: "Edit Custom API Provider",
        namePlaceholder: "e.g. My OpenAI Proxy",
        baseUrl: "Base URL",
        baseUrlHint: "Use an OpenAI-compatible base URL (usually ends with /v1).",
        apiKey: "API Key",
        defaultModel: "Default Model",
        defaultModelHint: "Used when starting a new conversation with the OpenAI-compatible engine.",
        defaultModelPickPlaceholder: "Click to detect models",
        defaultModelNoModels: "No models detected (click to retry)",
        defaultModelManual: "Enter model ID manually",
        defaultModelManualPlaceholder: "e.g. gpt-4.1",
        models: "Models",
        autoDetect: "Auto-detect",
        detectModels: "Detect Models",
        detecting: "Detecting...",
        detectOk: "Found {{count}} models ({{latency}} ms).",
        detectHint: "Paste Base URL + API key to auto-detect models.",
        detectHintClickModel: "After entering Base URL + API key, click the Default Model field to detect models.",
        protocolMismatch: "Detected protocol: {{protocol}} (not OpenAI-compatible).",
        goToClaude: "Go to Claude",
        goToClaudeHint: "This endpoint looks like Anthropic/Claude. Configure it in the Claude tab.",
        geminiNotSupported: "This endpoint looks like Gemini. Gemini is not supported here yet.",
        fixedBaseUrlFound: "Suggested Base URL: {{baseUrl}}",
        applyFixedBaseUrl: "Apply",
        importModels: "Import Models",
        importModelsHint: "Replace the model list below with the detected models.",
        suggestClaude: "Detected Anthropic/Claude protocol. Switch to Claude provider.",
        suggestGemini: "Detected Gemini protocol. Switch to Gemini provider.",
        suggestCheckKey: "API key looks invalid for the detected protocol.",
      },
      deleteConfirm: {
  ...
  workspace: {
    ...
    engineOpenAICompatible: "Custom API",
